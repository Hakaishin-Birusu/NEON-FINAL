...
import { ChainId, Currency, CurrencyAmount, ETHER, JSBI, Percent, Token } from '@vixelloswap/sdk'
import { abi as IUniswapV2Router02ABI } from '../abis/IVixelloswapPair.json'
